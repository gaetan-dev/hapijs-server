...
PagesLinkBuilder.prototype = (function () {
	...
	return {
		...
		setNextPage : function() {
			this.links.next = buildLink(this.options.url, (Number(this.options.page) + 1), this.options.perPage)
		},
		setPrevPage : function() {
			this.links.prev = buildLink(this.options.url, (Number(this.options.page) - 1), this.options.perPage)
		},
